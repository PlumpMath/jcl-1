...
public class AdvancedGraphics {
	...
	private static final ResourceBundle RESOURCE_BUNDLE = /*ResourceBundle.getBundle("examples_graphics");*/
			ResourceBundle.getBundle("examples_graphics", new Locale(""),Thread.currentThread().getContextClassLoader());
	
	static Image loadImage (Device device, Class clazz, String string) {
		InputStream stream = /*clazz*/Thread.currentThread().getContextClassLoader().getResourceAsStream ("org/eclipse/swt/examples/graphics/"+string);
	...
	public static void main(String[] args) {
		System.out.println("RESOURCE_BUNDLE:"+RESOURCE_BUNDLE);
